			...
			'<div class="ui-widget-content plupload_container">' +
				'<div class="ui-state-default ui-widget-header plupload_header">' +
					'<div class="plupload_header_content">' +
						...
						'<div class="plupload_header_title">' + _("Selecciona las imagenes") + '</div>' +
						'<div class="plupload_header_text">' + _("Agregar una imagen y selecionar el boton agregar") + '</div>' +
				...
				'<div class="plupload_content">' +
					'<div class="plupload_droptext">' + _("Arrastra la imagen aqui") + '</div>' +
				...
				'<tr>' +
					'<td class="plupload_cell plupload_file_name">' +
						'<div class="plupload_buttons"><!-- Visible -->' +
							'<a class="plupload_button plupload_add">' + _("Agregar Archivo") + '</a>&nbsp;' +
